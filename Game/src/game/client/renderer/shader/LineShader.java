...
public class LineShader extends ShaderProgram {
	...
	private static final String VERTEX_FILE = "res/shaders/line.vert";
	private static final String FRAGMENT_FILE = "res/shaders/line.frag";
	...
	public void loadLineColor(Vector3f color){
		super.loadVector3f(location_lineColor, color);
	}
}