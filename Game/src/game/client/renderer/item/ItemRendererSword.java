...
public class ItemRendererSword implements IItemRenderer{

	protected static final String MODEL_FOLDER = "res/models/items/";
	private static final TextureData TEXTURE = TextureManager.getDefaultGuiTexture("items/sword", 256, 256);

	private LoadedModel model;

	public ItemRendererSword(){
		IndexedModel indexedModel = OIMModelLoader.loadModel(new File(MODEL_FOLDER + "sword" + ".oim"));
	...
	public void renderItemInHand(Shader shader, Entity entity, double delta) {
		...
		Vector3f HAND_TRANSLATION = new Vector3f(0.6f,-0.5f,-0.9f);
		...
		//modelMatrix.scale(new Vector3f(0.1f));
