...
public class Tessellator {
	...
	private boolean isUsingUniformNormal = false;
	...
	private void tesselateTriangledQuad(){
		...
		Vector3f tangent0 = new Vector3f(normalX, normalY, normalZ);
		Vector3f tangent1 = new Vector3f(normalX, normalY, normalZ);
		Vector3f tangent2 = new Vector3f(normalX, normalY, normalZ);

		if(!isUsingUniformNormal){
			//Tangent for vertex 0
			tangent0 = calculateTangent(v0, v1, v2);
			//Tangent for vertex 3
			tangent1 = calculateTangent(v0, v2, v3);
			//Tangent for vertex 1,2
			tangent2 = Vector3f.add(tangent0, tangent1);
		}
	...
	public void setNormal(float normX, float normY, float normZ){
		...
		this.normalY = normY;
		this.normalZ = normZ;
		this.isUsingUniformNormal = true;
	}
